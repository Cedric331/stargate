...
<!-- START_9fb90cffc68a55a08f9c4b6157f17178 -->
...
```bash
curl -X GET \
    -G "http://localhost/api/personnages/name/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/api/personnages/name/1"
);
...
### HTTP Request
`GET api/personnages/name/{name}`


<!-- END_9fb90cffc68a55a08f9c4b6157f17178 -->
